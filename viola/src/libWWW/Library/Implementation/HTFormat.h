...
/*
 *	For reentrance, must call HTPushInputBuffer() before calling
 *	HTInitInput(), and call HTPopInputBuffer() afterwards.   PYW.
 */
extern BOOL HTPushInputBuffer NOARGS;
extern BOOL HTPopInputBuffer NOARGS;
