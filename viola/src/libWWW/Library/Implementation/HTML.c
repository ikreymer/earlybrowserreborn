...
static char * ISO_Latin1[] = {
	...
	"\040", /* emsp, em space - not collapsed (40 is INCORRECT) */
	"\040", /* ensp, en space - not collapsed (40 is INCORRECT) */
  	...
  	"",	/* infin -- special cases */
	"",	/* integral -- special cases */
  	"\357",	/* small i, dieresis or umlaut mark */ 
	"\042", /* left double quote (IS NOW ACTUALLY '"')*/
  	"\074=",	/* <= */ 
  	"\074",	/* less than */ 
	"\040",	/* nbsp, non breaking space (40 is INCORRECT) */
  	"\361",	/* small n, tilde */ 
...
PRIVATE void HTML_put_string ARGS2(HTStructured *, me, CONST char*, s)
{
	...
	char *cp;
	for (cp = s; *cp; cp++) majorBuff[majorBuffi++] = *cp;
...
PRIVATE void HTML_progress ARGS2(HTStructured *, me, int, l)
{
}
...
*/
	...
	CB_HTML_stag(element_number, present, value, tagInfo);
/*
...
PRIVATE void HTML_end_document ARGS1(HTStructured *, this)/*PYW from old lib*/
...
{		
	"text/html",
	HTML_free,
	HTML_end_document,/*PYW*/
	HTML_abort,
	HTML_put_character, 	HTML_put_string,
	HTML_progress,
	HTML_write,
