...
SlotInfo cl_txtEdit_CSlots[] = {
{
	...
	(long)"\n\
		...
		break;\n\
		default:\n\
			print(\"unknown message, clsss = txtEdit: args: \");\n\
...
int meth_txtEdit_initialize(self, result, argc, argv)
	VObj *self;
	Packet *result;
	int argc;
	Packet argv[];
...
int meth_txtEdit_expose(self, result, argc, argv)
	VObj *self;
	Packet *result;
	int argc;
	Packet argv[];
...
int meth_txtEdit_render(self, result, argc, argv)
	VObj *self;
	Packet *result;
	int argc;
	Packet argv[];
